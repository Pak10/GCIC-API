...
class AuthController extends Controller
{
    ...
    public function verifyAuthOtp(Request $request)
    {
        ...
        if($verify_otp){
            ...
            $user = User::with(['details', 'roles', 'userStatus', 'registration'])->where('id', $user->id)->first();
    ...
    public function getProfile(Request $request)
    {
        ...
        $user = User::with(['details', 'roles', 'userStatus', 'accounts.type', 'registration'])->where('id', $user->id)->first();
